...
from src.core.analysis.confluence import ConfluenceAnalysis

@dataclass
class MarketAnalyzer:
    """Analyzes market data using standardized CCXT fields."""

    def __init__(self, config: Dict[str, Any], logger: Logger, confluence_analyzer: Optional[ConfluenceAnalysis] = None):
        self.config = config
        self.logger = logger
        ...
        self.confluence_analyzer = confluence_analyzer or ConfluenceAnalysis(config)
