...
#############################################################################
# Script: fix_metrics_manager_di.sh
# Purpose: Deploy and manage fix metrics manager di
...
#
# Usage:
#   ./fix_metrics_manager_di.sh [options]
#   
#   Examples:
#     ./fix_metrics_manager_di.sh
#     ./fix_metrics_manager_di.sh --verbose
#     ./fix_metrics_manager_di.sh --dry-run
#
# Options:
