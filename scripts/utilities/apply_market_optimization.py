...
def apply_optimizations():
    ...
    print("\nNext steps:")
    print("1. Deploy to server: scp src/api/routes/market.py linuxuser@${VPS_HOST}:/home/linuxuser/trading/Virtuoso_ccxt/src/api/routes/")
    print("2. Restart server: ssh linuxuser@${VPS_HOST} '...'")
