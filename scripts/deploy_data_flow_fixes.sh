...
STATUS=$(curl -s -o /dev/null -w "%{http_code}" http://VPS_HOST_REDACTED:8002/api/dashboard-unified/unified)
if [ "$STATUS" = "200" ]; then
...
echo "  • Performance: http://VPS_HOST_REDACTED:8002/api/dashboard-unified/performance"
echo ""
