...
def apply_simple_timeout_fix():
    ...
    cmd1 = '''ssh linuxuser@45.77.40.77 "cd /home/linuxuser/trading/Virtuoso_ccxt && sed -i 's/async with asyncio.timeout(15.0):/async with asyncio.timeout(10.0):/g' src/core/exchanges/bybit.py"'''
    
    # Fix 2: Update error message
    cmd2 = '''ssh linuxuser@45.77.40.77 "cd /home/linuxuser/trading/Virtuoso_ccxt && sed -i 's/Request timeout after 15s:/Request timeout after 10s:/g' src/core/exchanges/bybit.py"'''
