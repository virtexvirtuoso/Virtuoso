...
ssh linuxuser@${VPS_HOST} "cat > /home/linuxuser/trading/Virtuoso_ccxt/src/core/cache/dashboard_cache_push.py" << 'EOF'
...
ssh linuxuser@${VPS_HOST} "cat >> /home/linuxuser/trading/Virtuoso_ccxt/src/core/dashboard_cache_manager.py" << 'EOF'
...
ssh linuxuser@${VPS_HOST} "/home/linuxuser/trading/Virtuoso_ccxt/venv311/bin/python -c \"
import asyncio
import aiomcache
import json
