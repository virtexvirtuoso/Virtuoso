...
curl -s http://${VPS_HOST}:8080/api/bitcoin-beta/health | python3 -m json.tool | head -10

echo -e "\nTesting /api/bitcoin-beta/realtime..."
curl -s http://${VPS_HOST}:8080/api/bitcoin-beta/realtime | python3 -m json.tool | head -20
...
echo ""
echo "API Endpoints:"
echo "  - http://${VPS_HOST}:8080/api/bitcoin-beta/health"
echo "  - http://${VPS_HOST}:8080/api/bitcoin-beta/realtime"
echo "  - http://${VPS_HOST}:8080/api/bitcoin-beta/history/{symbol}"
echo ""
