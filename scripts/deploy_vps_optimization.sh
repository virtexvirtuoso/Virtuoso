...
# Optimized for: 4 vCPU, 16GB RAM, 160GB SSD, Singapore VPS (VPS_HOST_REDACTED)
...
echo "========================================"
echo "Target: Singapore VPS (VPS_HOST_REDACTED)"
...
echo ""
echo "🌐 Access URLs:"
echo "  • Desktop Dashboard: http://VPS_HOST_REDACTED:8003/"
echo "  • Mobile Dashboard: http://VPS_HOST_REDACTED:8003/mobile"
echo "  • Health Check: http://VPS_HOST_REDACTED:8003/health"
echo "  • Monitoring API: http://VPS_HOST_REDACTED:8001/api/monitoring/status"
echo ""
