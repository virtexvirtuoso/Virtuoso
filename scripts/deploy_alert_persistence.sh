...
curl -s "http://5.223.63.4:8000/api/alerts/persisted/stats?hours=1" | head -100
...
echo "🔍 To query specific alert: curl http://5.223.63.4:8000/api/alerts/persisted/WA-1755686017-API3USDT"