...
#############################################################################
# Script: fix_orderflow_liquidity_zones.sh
# Purpose: Deploy and manage fix orderflow liquidity zones
...
#
# Usage:
#   ./fix_orderflow_liquidity_zones.sh [options]
#   
#   Examples:
#     ./fix_orderflow_liquidity_zones.sh
#     ./fix_orderflow_liquidity_zones.sh --verbose
#     ./fix_orderflow_liquidity_zones.sh --dry-run
#
# Options:
