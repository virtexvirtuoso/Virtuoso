...
echo ""
echo "📊 Next steps:"
echo "1. Monitor the dashboard at http://VPS_HOST_REDACTED:8003/"
echo "2. Check mobile dashboard at http://VPS_HOST_REDACTED:8003/mobile"
...
echo "  curl http://VPS_HOST_REDACTED:8003/api/dashboard/mobile | jq '.confluence_scores[0]'"
echo ""