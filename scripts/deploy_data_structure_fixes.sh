...
echo ""
echo "📊 Next steps:"
echo "1. Monitor the dashboard at http://5.223.63.4:8003/"
echo "2. Check mobile dashboard at http://5.223.63.4:8003/mobile"
...
echo "  curl http://5.223.63.4:8003/api/dashboard/mobile | jq '.confluence_scores[0]'"
echo ""