...
#############################################################################
# Script: test_binance_api_curl.sh
# Purpose: Test and validate test binance api curl
...
#
# Usage:
#   ./test_binance_api_curl.sh [options]
#   
#   Examples:
#     ./test_binance_api_curl.sh
#     ./test_binance_api_curl.sh --verbose
#     ./test_binance_api_curl.sh --dry-run
#
# Options:
