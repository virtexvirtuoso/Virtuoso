#!/usr/bin/env python3
"""Quick test to show enhanced OI and CVD analysis with live data."""
...
async def quick_test():
    ...
    print('🎯 Both indicators now use multi-dimensional price relationship analysis!')
