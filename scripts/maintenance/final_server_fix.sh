...
echo "🔧 Final server fix for Virtuoso on 5.223.63.4"
echo "=============================================="
...
test_endpoint "http://5.223.63.4:8003/dashboard" "Main Dashboard"
test_endpoint "http://5.223.63.4:8003/dashboard/desktop" "Desktop Route"
test_endpoint "http://5.223.63.4:8003/dashboard/v10" "V10 Route"
test_endpoint "http://5.223.63.4:8003/dashboard/mobile" "Mobile Route"

echo ""
echo "   Testing API endpoints:"
test_endpoint "http://5.223.63.4:8003/health" "Health Check"
test_endpoint "http://5.223.63.4:8003/api/dashboard/overview" "Dashboard API"

# Test Market Overview API with timing
echo ""
echo "7. Testing Market Overview API performance:"
start_time=$(date +%s.%N)
response=$(curl -s -o /dev/null -w "%{http_code}" "http://5.223.63.4:8003/api/market/overview" --max-time 30)
end_time=$(date +%s.%N)
...
echo "  V10:     http://5.223.63.4:8003/dashboard/v10"
echo ""
echo "To monitor logs:"
echo "  ssh linuxuser@5.223.63.4 'tail -f /home/linuxuser/trading/Virtuoso_ccxt/web_server.log'"