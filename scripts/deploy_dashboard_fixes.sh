...
echo "Test endpoints:"
echo "  curl http://5.223.63.4:8003/api/dashboard-cached/overview"
echo "  curl http://5.223.63.4:8003/api/dashboard-cached/mobile-data"
echo "  curl http://5.223.63.4:8003/api/dashboard-cached/opportunities"
