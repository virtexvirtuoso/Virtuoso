...
echo "🔧 Fixing web server on Hetzner VPS (VPS_HOST_REDACTED)..."
...
scp /tmp/start_web_server_standalone.py linuxuser@VPS_HOST_REDACTED:/tmp/
...
echo ""
echo "🌐 Dashboard URLs:"
echo "   Desktop: http://VPS_HOST_REDACTED:8003/"
echo "   Mobile:  http://VPS_HOST_REDACTED:8003/mobile"
echo ""
echo "Testing external health check..."
curl -s -o /dev/null -w "External Status: %{http_code}\n" http://VPS_HOST_REDACTED:8003/health
