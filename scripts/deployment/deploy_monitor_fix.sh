...
ssh pi "chmod +x /tmp/vps_deploy_commands.sh && scp /tmp/monitor_fixed.py linuxuser@${VPS_HOST}:/tmp/ && scp /tmp/vps_deploy_commands.sh linuxuser@${VPS_HOST}:/tmp/ && ssh linuxuser@${VPS_HOST} 'chmod +x /tmp/vps_deploy_commands.sh && /tmp/vps_deploy_commands.sh'"
