...
#############################################################################
# Script: deploy_pdf_fix_v2.sh
# Purpose: Deploy and manage deploy pdf fix v2
...
#
# Usage:
#   ./deploy_pdf_fix_v2.sh [options]
#   
#   Examples:
#     ./deploy_pdf_fix_v2.sh
#     ./deploy_pdf_fix_v2.sh --verbose
#     ./deploy_pdf_fix_v2.sh --dry-run
#
# Options:
