...
echo "   scp src/dashboard/dashboard_integration.py root@5.223.63.4:/root/Virtuoso/src/dashboard/"
echo
echo "2. SSH into the VPS:"
echo "   ssh root@5.223.63.4"
echo
...
echo "   http://5.223.63.4:8003/dashboard/mobile"
echo
