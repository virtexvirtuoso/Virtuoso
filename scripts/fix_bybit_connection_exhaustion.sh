...
#############################################################################
# Script: fix_bybit_connection_exhaustion.sh
# Purpose: Deploy and manage fix bybit connection exhaustion
...
#
# Usage:
#   ./fix_bybit_connection_exhaustion.sh [options]
#   
#   Examples:
#     ./fix_bybit_connection_exhaustion.sh
#     ./fix_bybit_connection_exhaustion.sh --verbose
#     ./fix_bybit_connection_exhaustion.sh --dry-run
#
# Options:
