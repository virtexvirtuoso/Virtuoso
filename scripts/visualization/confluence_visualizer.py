...
if __name__ == "__main__":
    ...
    plt.savefig('exports/confluence_visualizations/confluence_radar_chart.png', dpi=300, bbox_inches='tight')
    plt.close()
    print("Radar chart saved as 'exports/confluence_visualizations/confluence_radar_chart.png'")
    
    # Create 3D visualization
    threed_fig = create_3d_confluence_visualization(component_scores, overall_score)
    threed_fig.write_html('exports/confluence_visualizations/confluence_3d_visualization.html')
    print("3D visualization saved as 'exports/confluence_visualizations/confluence_3d_visualization.html'")
