...
#############################################################################
# Script: fix_bybit_timeouts_vps.sh
# Purpose: Deploy and manage fix bybit timeouts vps
...
#
# Usage:
#   ./fix_bybit_timeouts_vps.sh [options]
#   
#   Examples:
#     ./fix_bybit_timeouts_vps.sh
#     ./fix_bybit_timeouts_vps.sh --verbose
#     ./fix_bybit_timeouts_vps.sh --dry-run
#
# Options:
