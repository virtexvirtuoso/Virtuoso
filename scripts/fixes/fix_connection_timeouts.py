...
def apply_connection_timeout_fix():
    ...
    cmd1 = '''ssh linuxuser@45.77.40.77 "cd /home/linuxuser/trading/Virtuoso_ccxt && sed -i 's/connect=10,/connect=15,/g' src/core/exchanges/bybit.py"'''
    
    # Also increase total timeout to accommodate
    cmd2 = '''ssh linuxuser@45.77.40.77 "cd /home/linuxuser/trading/Virtuoso_ccxt && sed -i 's/total=30,/total=35,/g' src/core/exchanges/bybit.py"'''
...
def monitor_connection_errors(minutes=3):
    ...
    while time.time() - start_time < minutes * 60:
        ...
        cmd = 'ssh linuxuser@45.77.40.77 "sudo journalctl -u virtuoso.service --since \'1 minute ago\' | grep -c \'Connection timeout\'"'
    ...
    # Final summary
    final_cmd = f'ssh linuxuser@45.77.40.77 "sudo journalctl -u virtuoso.service --since \'{minutes} minutes ago\' | grep -c \'Connection timeout\'"'
